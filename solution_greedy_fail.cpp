...
// can not solve amount = 18, coins = {1, 6, 7}
// when we use greedy method, we will get output = 6 (7+7+1+1+1+1)
// However, we only need to use three "6" to combine "18", the output should be 3
